    ...
    function (t, e) {
        class n extends elementorModules.frontend.handlers.Base {
            ...
            onClick() {
                ...
                "self_hosted" === e
                    ...
                    this.elements.$link.on("click", function (t) {
                        t.preventDefault(),
                            Swal.fire({
                                showCloseButton: !0,
                                showCancelButton: !1,
                                ...
                                customClass: {
                                    container:
                                        "jkit-swal-container jkit-video-button-popup-container",
        ...
        jQuery(window).on("elementor/frontend/init", () => {
            elementorFrontend.hooks.addAction(
                "frontend/element_ready/jkit_video_button.default",
                (t) => {
