...
!(function (e, t) {
    ...
    function ae(e, t, o) {
        Y(e, o[`show${s(t)}Button`], "inline-block"),
            H(e, o[`${t}ButtonText`]),
    ...
    const Re = (t) => {
        ...
        We = (e, t, n) => {
            ...
            "function" == typeof n.willClose && n.willClose(t),
                i
                    ? ze(e, t, o, n.returnFocus, n.didClose)
                    : Ne(e, o, n.returnFocus, n.didClose);
        },
        ze = (e, t, n, o, i) => {
            (Q.swalCloseEventFinishedCallback = Ne.bind(null, e, n, o, i)),
        ...
        Et = (e) => {
            for (let t = e.target; t && t !== document; t = t.parentNode)
                for (const e in xt) {
                    ...
                    if (n) return void xt[e].fire({ template: n });
                }
        };
    var $t = Object.freeze({
        __proto__: null,
        argsToParams: (e) => {
            const t = {};
            return (
                "object" != typeof e[0] || At(e[0])
                    ? ["title", "html", "icon"].forEach((n, o) => {
                          const i = e[o];
                          "string" == typeof i || At(i)
                              ? (t[n] = i)
                              : void 0 !== i &&
                                a(
        ...
        bindClickHandler: function () {
            let e =
                arguments.length > 0 && void 0 !== arguments[0]
                    ...
                    : "data-swal-template";
            (xt[e] = this),
                Pt || (document.body.addEventListener("click", Et), (Pt = !0));
        },
    ...
    const Lt = ["swal-title", "swal-html", "swal-footer"],
        ...
        Mt = (e, t) => {
            re && X(t)
                ? ((e.style.overflowY = "hidden"), t.addEventListener(re, jt))
    ...
    class Nt {
        ...
        _main(t) {
            ...
            ((e) => {
                ...
                Q.currentInstance &&
                    (Q.currentInstance._destroy(), O() && Ie()),
                (Q.currentInstance = Vt);
            const o = Rt(t, n);
            Dt(o),
                Object.freeze(o),
    ...
    const Ft = (t, n, o) =>
            new Promise((i, s) => {
                ...
                He.swalPromiseResolve.set(t, i),
                    He.swalPromiseReject.set(t, s),
                    (n.confirmButton.onclick = () => {
                        ((t) => {
                            const n = e.innerParams.get(t);
                            t.disableButtons(),
                                n.input ? gt(t, "confirm") : wt(t, !0);
                        })(t);
                    }),
