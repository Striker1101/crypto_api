            ...
            runSticky() {
                ...
                const e = this,
                    ...
                    n = i.hasClass("jkit-sticky-element-on--down")
                        ...
                        ? "up"
                        : "both",
                    o = i.hasClass("jkit-sticky-position--fixed")
                        ? "fixed"
                        : "sticky";
                    ...
                    t(window).on("load resize scroll", i, function (c) {
                        ...
                        if (
                            ("fixed" === o &&
                                ...
                                (e.margin = i.css("margin")),
                                i.wrap(
                                    '<div class="wrapper-sticky-fixed"></div>'
                                ),
                                i.parent().css("width", e.width),
                                i.parent().css("height", e.height),
                                i.parent().css("margin", e.margin),
                            ...
                            Object.values(s.jkit_sticky_device).forEach(
                                function (e) {
                                    a !== e || (h = !1);
                                }
                            ),
            ...
            hideOnScroll(e, t, i, s, n) {
                if ("scroll" === s.type) {
                    if ("down" === i) {
                        ...
                        if (
                            e > t &&
                            n.hasClass("jkit-sticky-element--hide-on-scroll")
                        )
