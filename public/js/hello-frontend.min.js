                    ...
                    (0, n.default)(elementorHelloThemeHandler, [
                        ...
                        },
                        {
                            ...
                            value: function initElements() {
                                this.elements = {
                                    ...
                                    $header: jQuery(
                                        this.settings.selectors.header
                                    ),
                                    $footer: jQuery(
                                        this.settings.selectors.footer
                                    ),
                                    $menuToggle: jQuery(
                                        this.settings.selectors.menuToggle
                                    ),
                        ...
                        },
                        {
                            ...
                            value: function closeMenuItems() {
                                var e = this;
                                this.elements.$menuToggleHolder.removeClass(
                                    "elementor-active"
                                ),
                                    this.elements.$window.off(
                                        "resize",
                                        function () {
                        ...
                        },
                        {
                            ...
                            value: function handleMenuToggle() {
                                ...
                                this.elements.$menuToggle.attr(
                                    ...
                                    this.elements.$dropdownMenu.attr(
                                        "aria-hidden",
                                        !t
                                    ),
