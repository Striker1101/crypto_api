var tns = (function () {
    ...
    var R = function (t) {
            ...
            var gt,
                ...
                Ne = {
                    ...
                    keydown: function (t) {
                        ...
                        if (g(e, "data-nav")) {
                            var i = [p.LEFT, p.RIGHT, p.ENTER, p.SPACE].indexOf(
                                    t.keyCode
                                ),
                        ...
                        (lt &&
                            (P || At
                                ? (f(
                                      ...
                                      "#" + be + " > .tns-item",
                                      "font-size:" +
                                          l.getComputedStyle(pt[0]).fontSize +
                                          ";",
                                      d(Ut)
                                  ),
                        ...
                        (a = Pn(
                            ...
                            Z &&
                                ((a =
                                    lt && !At
                                        ? "width:" +
                                          zn(t.fixedWidth, t.gutter, t.items) +
                                          ";"
                                        : ""),
                                F && (a += jn(It)),
                                f(Ut, "#" + be, a, d(Ut))),
                            (a =
                                lt && !At
                                    ? Wn(t.fixedWidth, t.gutter, t.items)
                                    : ""),
                ...
                (function t(e) {
                    if (null != e) {
                        ...
                        return (
                            e.appendChild(r),
                            (a =
                                (i = r.getBoundingClientRect()).right - i.left),
                            r.remove(),
                            a || t(e.parentNode)
                        );
                    }
        ...
        function Wn(t, e, n) {
            ...
            return (
                (i = "width:" + i), "inner" !== _ ? i + ";" : i + " !important;"
            );
        }
        function qn(t) {
            var e = "";
        ...
        function Un(e) {
            if (yt) {
                ...
                if (
                    ...
                    Me &&
                        ...
                        (Te
                            ...
                            : ((function () {
                                  if (Ee) {
                                      if (
                                          (Lt && z && (ct.style.margin = ""),
                                          te)
                                      )
                                          for (
                                              var t = "tns-transparent", e = te;
                                              e--;
                    ...
                    jt !== b && (jt ? (E($e), _i()) : T($e)),
                    Vt !== w &&
                        (Vt ? O(ft, He, t.preventScrollOnTouch) : D(ft, He)),
                    ...
                    if (
                        ...
                        qt &&
                            Ft !== H &&
                            ((Ke.innerHTML = Ft[0]), (Je.innerHTML = Ft[1])),
                        mn && Yt !== R)
                    ) {
                        var W = Qt ? 1 : 0,
                            q = mn.innerHTML,
        ...
        function mi() {
            ...
            v(pt, function (t, i) {
                e <= i && i <= n
                    ? g(t, "aria-hidden") &&
                      (C(t, ["aria-hidden", "tabindex"]), m(t, We))
                    : g(t, "aria-hidden") ||
                      (w(t, { "aria-hidden": "true", tabindex: "-1" }),
                      y(t, We));
            });
        ...
        function Ei(t) {
            ...
            return (
                ne && (e = Math.max(e, ie)), e + (!lt || At || Nt ? "px" : "%")
            );
        }
        function Ai(t) {
            Ci(ft, "0s"), Ni(t);
        ...
        function Li(t, e, n, i) {
            ...
            for (var r = t; r < a; r++) {
                ...
                i || (o.style.left = (100 * (r - se)) / Ot + "%"),
                    at &&
                        j &&
                        (o.style[j] = o.style[G] = (at * (r - t)) / 1e3 + "s"),
                    y(o, e),
                    m(o, n),
                    i && $t.push(o);
            }
                    ...
                    if (
                        ("first" === t
                            ...
                            : ("number" != typeof t && (t = parseInt(t)),
                              isNaN(t) ||
                                  (e || (t = Math.max(0, Math.min(ht - 1, t))),
                                  (i = t - n))),
                        !Z && i && Math.abs(i) < Ot)
                    ) {
                        var a = 0 < i ? 1 : -1;
        ...
        function Xi(t) {
            ...
            ge.emit(Vi(t) ? "touchStart" : "dragStart", Zi(t)),
                ...
                (Cn.y = wn.y = e.clientY),
                Z &&
                    ((xn = parseFloat(ft.style[re].replace(oe, ""))),
                    Ci(ft, "0s"));
        }
        function Yi(t) {
            if (Mn) {
